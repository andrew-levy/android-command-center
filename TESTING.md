...
Before testing Database, Preferences, Deeplinks, App data, Stream, or Location, install and launch `fullDebug` once.
...
- Preferences: Scan `com.example.androidclitest`, open a `shared_prefs` XML file, edit a value or add a key, push, force-stop/relaunch, then verify in-app.
