...
- parent monorepo folder with the Project gear pointing at a nested Android app; selecting a folder without `gradlew` is rejected, and changing the root refreshes variants/deeplinks;
